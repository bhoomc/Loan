...
public class LoanServiceTest {
    ...
    @DisplayName("Test get loan info id by equals 1 should return loan information ")
    @Test
    void testGetLoanInfoBodyEquals1() throws Exception {
    ...
    @DisplayName("Test get loan info id by equals 2 should return loan information ")
    @Test
    void testGetLoanInfoBodyEquals2()  {
        Long reqParam = 2L;
    ...
    @DisplayName("Test get loan info id by equals 3 should return loan information ")
    @Test
    void testGetLoanInfoBodyEquals3()  {
        Long reqParam = 3L;
